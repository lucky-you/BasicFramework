package com.zhowin.library.empty;
...
public class LoadingController implements LoadingInterface {
    ...
    public void showLoading() {
        ...
        loadingView = inflater.inflate(R.layout.include_loading_data_layout, null);
    ...
    public void showNetworkError() {
        ...
        networkErrorView = inflater.inflate(R.layout.include_network_error_layout, null);
        TextView tvNetworkErrorMessage = (TextView) networkErrorView.findViewById(R.id.tv_errorMessage);
        TextView btnRetry = (TextView) networkErrorView.findViewById(R.id.btn_retry);
    ...
    public void showError() {
        ...
        errorView = inflater.inflate(R.layout.include_network_error_layout, null);
        ...
        TextView btnRetry = (TextView) errorView.findViewById(R.id.btn_retry);

        ivError.setImageResource(R.drawable.svg_data_error);
    ...
    public void showEmpty() {
        ...
        emptyView = inflater.inflate(R.layout.include_network_error_layout, null);
        ...
        TextView btnTodo = (TextView) emptyView.findViewById(R.id.btn_retry);

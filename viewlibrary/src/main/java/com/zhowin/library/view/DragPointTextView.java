...
public class DragPointTextView extends AppCompatTextView {
    ...
    public DragPointTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initBackground();
    }
    ...
    public void setBackgroundColor(int backgroundColor) {
        ...
        DragPointTextView.this.setBackgroundDrawable(createStateListDrawable((getHeight() > getWidth() ? getHeight()
    ...
    private void initBackground() {
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (!initBgFlag) {
                    DragPointTextView.this.setBackgroundDrawable(createStateListDrawable(
        ...
        public void cancel() {
            ...
            set.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    DragPointTextView.this.setVisibility(View.VISIBLE);
                }
            });
            set.start();

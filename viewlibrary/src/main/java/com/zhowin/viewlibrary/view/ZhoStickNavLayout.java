 ...
 * description:滑动列表头部悬停的控件，垂直布局
 */
public class ZhoStickNavLayout extends LinearLayout implements NestedScrollingParent {
    ...
    public ZhoStickNavLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        ...
        mTop = findViewById(R.id.id_zho_stick_layout_top_view);
        mNav = findViewById(R.id.id_zho_stick_layout_tab_layout);
        View view = findViewById(R.id.id_zho_stick_layout_viewpager);
        if (!(view instanceof ViewPager)) {
            throw new RuntimeException("id_zho_stick_layout_viewpager show used by ViewPager !");
        }

...
public class RulerView extends View {
    ...
    private void initAttrs(AttributeSet attrs, int defStyleAttr) {
        ...
        bgColor = a.getColor(R.styleable.RulerView_rv_bgColor, getColor(R.color.default_ruler_view_bg_color));
        smallScaleColor = a.getColor(R.styleable.RulerView_rv_smallScaleColor, getColor(R.color.default_ruler_view_small_scale_color));
        midScaleColor = a.getColor(R.styleable.RulerView_rv_midScaleColor, getColor(R.color.default_ruler_view_mid_scale_color));
        largeScaleColor = a.getColor(R.styleable.RulerView_rv_largeScaleColor, getColor(R.color.default_ruler_view_large_scale_color));
        scaleNumColor = a.getColor(R.styleable.RulerView_rv_scaleNumColor, getColor(R.color.default_ruler_view_scale_num_color));
        resultNumColor = a.getColor(R.styleable.RulerView_rv_resultNumColor, getColor(R.color.default_ruler_view_result_num_color));
        unitColor = a.getColor(R.styleable.RulerView_rv_unitColor, getColor(R.color.default_ruler_view_unit_color));
